...
const char* mqtt_topic = "contaminacion";
...
void loop()
{
  ...
  sensorVoltage = (sensorValue/1024*3.3)*100;
 ...
 //send data every second
  ...
  if (now - lastMsg > 6000) {
    int SV = sensorVoltage;
    lastMsg = now;
    String msg="Voltage: "+SV;
    msg= msg+ sensorVoltage;
    ...
    String data = "unidad_medida_1=Voltage+C&dato_1=";
    data = data + SV;
    data = data + "&codigo_sensor=humo&accion=agregar";
